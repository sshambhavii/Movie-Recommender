...
def load_view():
    st.subheader(
        "Link to presentation : [link](https://docs.google.com/presentation/d/14RP34G1DcIOCxGKS6gvtUTiez5mdWwbC/edit?usp=sharing&ouid=113614194640103768865&rtpof=true&sd=true)")
